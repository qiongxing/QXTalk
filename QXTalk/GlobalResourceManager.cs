    ...
    internal class GlobalResourceManager
    {
        ...
        public static void PreInitialize()
        {
            try
            {
                ...
                GlobalResourceManager.noneIcon64 = global::QXTalk.Properties.Resources.None64;
                GlobalResourceManager.groupIcon = ImageHelper.ConvertToIcon(global::QXTalk.Properties.Resources.normal_group_40, 64);
                ...
                GlobalResourceManager.mainBackImage = Image.FromFile(resourceDir + "MainBackImage.png");
                GlobalResourceManager.emotionList = emotionList;
                GlobalResourceManager.loginBackImage = Image.FromFile(resourceDir+"BackImage.png");
            }
            catch (Exception ee)
            {
